...
*/
-- CreateEnum
CREATE TYPE "Gender" AS ENUM ('NOT_MENTIONED', 'MALE', 'FEMALE', 'OTHER');

-- CreateEnum
CREATE TYPE "RelationshipStatus" AS ENUM ('NOT_MENTIONED', 'SINGLE', 'MARRIED', 'ENGAGED', 'IN_A_RELATIONSHIP');
...
ADD COLUMN     "gender" "Gender" DEFAULT 'NOT_MENTIONED',
ADD COLUMN     "relationship" "RelationshipStatus" DEFAULT 'NOT_MENTIONED',
...
-- AddForeignKey
ALTER TABLE "FollowRequest" ADD CONSTRAINT "FollowRequest_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
